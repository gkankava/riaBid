    ...
    <section id="shop" className="container">
      <div className="dashboard-container">
        ...
        <div className="flex column  contact-container dashboard">
          <h2 style={{ marginBottom: "1vw" }}>Edit Artwork</h2>
          <form
          ...
          >
            ...
            <input
              value={title || data.data.artwork.title}
            ...
            ></input>
            <input
              value={medium || data.data.artwork.medium}
            ...
            <div className="flex space-between smaller">
              <input
                value={height || data.data.artwork.height}
              ...
              ></input>
              <input
                value={width || data.data.artwork.width}
              ...
              ></input>{" "}
              <input
                value={depth || data.data.artwork.depth}
              ...
              ></input>
              <select
                value={units || data.data.artwork.units}
            ...
            <div style={{ position: "relative" }}>
              {" "}
              <input
                value={buy_it_now || data.data.artwork.buy_it_now}
            ...
            <input
              value={year || data.data.artwork.year}
            ...
            ></input>
            <textarea
              value={description || data.data.artwork.description}
